...
lang['common']['delete'] 	= 'kasować';
lang['common']['require'] 	= 'Nie może być pusty';
lang['common']['pst_integer'] 	= 'Wpisz liczbę całkowitą> 0';
lang['common']['valid_money'] 	= 'Proszę podać poprawny format liczby';
lang['common']['reset'] 		= 'powrót';
...
lang['common']['confirm_delete'] 	= 'BestätigenSiedieLöschung?';
lang['common']['confirm_restore'] 	= '确认是否还原?'; 
lang['common']['confirm'] 	= '确认执行该操作?'; 
lang['common']['search_success'] 	= '数据加载完成'; 
lang['common']['error_msg'] = '错误提示'; 
lang['common']['success'] 	= 'z powodzeniem realizowane!';
lang['common']['error'] 	= 'Operacja nie powiodła się!';
...
lang['common']['normal']		= 'normalny';
lang['common']['order_normal']		= '未装柜';
lang['common']['op_error']		= '操作错误！',
lang['common']['restore']		= 'przywrócić',
lang['common']['submit']		= '提交',
lang['common']['close']			= 'blisko',
lang['common']['add_open']		= 'Rozbudowa',
...
/*******合并订单******/
lang['sale']['two_more']	        = 'Łączący rozkazy muszą być dwa lub więcej';
...
lang['question']['wait_response']         = 'Odpowiedź czeka';
lang['question']['has_compensation']      = 'Już odszkodowania';
