...
return array(
    ...
    '_TOKEN_ERROR_'=>'表单令牌错误，AJAX表单多次提交还在修改……',
    '_RECORD_HAS_UPDATE_'=>'记录已经被其他用户更新，请刷新列表',
    '_RECORD_NULL_'=>'该单据已被其他用户删除，请刷新列表',
    '_DELETE_NULL_'=>'该单据已被其他用户删除，请刷新列表',
