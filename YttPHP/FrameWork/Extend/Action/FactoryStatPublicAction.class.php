...
class FactoryStatPublicAction extends RelationCommonAction {
	...
	public function index() { 
        if (!empty($_POST['search_form'])) {
           ...
           ///获取当前Action名称
            ...
            $this->assign('company_currency_count',C('factory_currency_count'));
            ///display
        }
			$this->displayIndex(); 
    	}
	...
	public function view() {  
            ...
            $this->factory_name	= SOnly('express', $client_id, 'express_name');
