<?php
/**
 * File for DHLWsdlClass to communicate with SOAP service
 * @package DHL
 ...
 */
/**
 * DHLWsdlClass to communicate with SOAP service
 * Documentation : The status of the operation and the manifest url (if available).
 * @package DHL
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-03-21
 */
class DHLWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'var/wsdltophp.com/storage/wsdls/de5d93845b86cf893b52c336479a60f2/wsdl.xml';
    /**
    ...
    /**
     * Constructor
     * @uses DHLWsdlClass::setLastError()
     * @uses DHLWsdlClass::initSoapClient()
     * @uses DHLWsdlClass::initInternArrayToIterate()
     * @uses DHLWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'DHLWsdlClass'))
            {
     ...
     * @uses DHLClassMap::classMap()
     * @uses DHLWsdlClass::getDefaultWsdlOptions()
     * @uses DHLWsdlClass::getSoapClientClassName()
     * @uses DHLWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('DHLClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = DHLClassMap::classMap();
     ...
     * If a class is named as {DHL}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('DHLSoapClient') && is_subclass_of('DHLSoapClient','SoapClient'))
            return 'DHLSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses DHLWsdlClass::WSDL_CACHE_WSDL
     * @uses DHLWsdlClass::WSDL_COMPRESSION
     * @uses DHLWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses DHLWsdlClass::WSDL_ENCODING
     * @uses DHLWsdlClass::WSDL_EXCEPTIONS
     * @uses DHLWsdlClass::WSDL_FEATURES
     * @uses DHLWsdlClass::WSDL_LOGIN
     * @uses DHLWsdlClass::WSDL_PASSWORD
     * @uses DHLWsdlClass::WSDL_SOAP_VERSION
     * @uses DHLWsdlClass::WSDL_STREAM_CONTEXT
     * @uses DHLWsdlClass::WSDL_TRACE
     * @uses DHLWsdlClass::WSDL_TYPEMAP
     * @uses DHLWsdlClass::WSDL_URL
     * @uses DHLWsdlClass::VALUE_WSDL_URL
     * @uses DHLWsdlClass::WSDL_USER_AGENT
     * @uses DHLWsdlClass::WSDL_PROXY_HOST
     * @uses DHLWsdlClass::WSDL_PROXY_PORT
     * @uses DHLWsdlClass::WSDL_PROXY_LOGIN
     * @uses DHLWsdlClass::WSDL_PROXY_PASSWORD
     * @uses DHLWsdlClass::WSDL_LOCAL_CERT
     * @uses DHLWsdlClass::WSDL_PASSPHRASE
     * @uses DHLWsdlClass::WSDL_AUTHENTICATION
     * @uses DHLWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses DHLWsdlClass::getSoapClient()
     * @uses DHLWsdlClass::getFormatedXml()
     ...
     * @uses DHLWsdlClass::getSoapClient()
     * @uses DHLWsdlClass::convertStringHeadersToArray()
     ...
     * @uses DHLWsdlClass::getInternArrayToIterate()
     * @uses DHLWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses DHLWsdlClass::getInternArrayToIterateOffset()
     * @uses DHLWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses DHLWsdlClass::getInternArrayToIterateOffset()
     * @uses DHLWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses DHLWsdlClass::getAttributeName()
     * @uses DHLWsdlClass::__toString()
     * @uses DHLWsdlClass::_set()
     * @uses DHLWsdlClass::_get()
     * @uses DHLWsdlClass::setInternArrayToIterate()
     * @uses DHLWsdlClass::setInternArrayToIterateIsArray()
     * @uses DHLWsdlClass::setInternArrayToIterateOffset()
