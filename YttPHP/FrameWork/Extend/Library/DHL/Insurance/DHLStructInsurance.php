<?php
/**
 * File for class DHLStructInsurance
 * @package DHL
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DHLStructInsurance originally named Insurance
 * Documentation : Container element must be set to provide insurance value.
 ...
 * @date 2016-03-21
 */
class DHLStructInsurance extends DHLWsdlClass
{
    /**
     * The InsuranceAmount
     * Meta informations extracted from the WSDL
