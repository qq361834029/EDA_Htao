<?php
/**
 * File for class DHLStructGetLabelTDRequest
 * @package DHL
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DHLStructGetLabelTDRequest originally named GetLabelTDRequest
 * Documentation : The identifier for the TD shipment for which the label url is requested. The version of the webservice implementation for which the requesting client is developed.
 ...
 * @date 2016-03-21
 */
class DHLStructGetLabelTDRequest extends DHLWsdlClass
{
    /**
     * The Version
