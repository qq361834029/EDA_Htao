<?php
/**
 * File for class DHLStructGetExportDocDDRequest
 * @package DHL
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DHLStructGetExportDocDDRequest originally named GetExportDocDDRequest
 * Documentation : The identifier for the DD shipment for which the export document url is requested. The version of the webservice implementation for which the requesting client is developed.
 ...
 * @date 2016-03-21
 */
class DHLStructGetExportDocDDRequest extends DHLWsdlClass
{
    /**
     * The Version
     ...
     * The ShipmentNumber
     * Meta informations extracted from the WSDL
     * - documentation : To request DD export documents, ShipmentNumber. ShipmentNumber is required. This parent element inherits from ShipmentNumberType, therefore all following subelements are valid according to schema, however the web service accepts shipmentNumber only.
     * - maxOccurs : 999
