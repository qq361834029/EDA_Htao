<?php
/**
 * File for class DHLStructDeleteShipmentTDRequest
 * @package DHL
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DHLStructDeleteShipmentTDRequest originally named DeleteShipmentTDRequest
 * Documentation : The identifier for the TD shipment which should be deleted. The version of the webservice implementation for which the requesting client is developed.
 ...
 * @date 2016-03-21
 */
class DHLStructDeleteShipmentTDRequest extends DHLWsdlClass
{
    /**
     * The Version
