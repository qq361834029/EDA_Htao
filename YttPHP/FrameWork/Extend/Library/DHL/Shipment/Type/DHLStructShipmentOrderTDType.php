<?php
/**
 * File for class DHLStructShipmentOrderTDType
 * @package DHL
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DHLStructShipmentOrderTDType originally named ShipmentOrderTDType
 ...
 * @date 2016-03-21
 */
class DHLStructShipmentOrderTDType extends DHLWsdlClass
{
    /**
     * The SequenceNumber
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ShipmentOrderTDType
     ...
     */
    public function __construct($_sequenceNumber = NULL,$_shipment = NULL,$_pickup = NULL,$_labelResponseType = NULL)
    {
        parent::__construct(array('SequenceNumber'=>$_sequenceNumber,'Shipment'=>$_shipment,'Pickup'=>$_pickup,'LabelResponseType'=>$_labelResponseType),false);
    }
    /**
