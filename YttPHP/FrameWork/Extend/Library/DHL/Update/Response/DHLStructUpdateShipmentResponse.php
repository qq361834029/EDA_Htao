<?php
/**
 * File for class DHLStructUpdateShipmentResponse
 * @package DHL
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DHLStructUpdateShipmentResponse originally named UpdateShipmentResponse
 ...
 * @date 2016-03-21
 */
class DHLStructUpdateShipmentResponse extends DHLWsdlClass
{
    /**
     * The Version
     ...
     * The CreationState
     * Meta informations extracted from the WSDL
     * - documentation : The operation's success status for the updated ShipmentOrder will be returned by this CreationState element.
     * - minOccurs : 0
