<?php
/**
 * File for class DHLStructDoManifestDDRequest
 * @package DHL
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DHLStructDoManifestDDRequest originally named DoManifestDDRequest
 * Documentation : The identifier for the DD shipment which should be manifested. The version of the webservice implementation for which the requesting client is developed.
 ...
 * @date 2016-03-21
 */
class DHLStructDoManifestDDRequest extends DHLWsdlClass
{
    /**
     * The Version
     ...
     * The ShipmentNumber
     * Meta informations extracted from the WSDL
     * - documentation : The identifier of the shipment. The shipment number is read from ShipmentNumberType->shipmentNumber
     * - maxOccurs : 999
     * @var DHLStructShipmentNumberType
     */
    public $ShipmentNumber;
    /**
     * Constructor method for DoManifestDDRequest
     * @see parent::__construct()
     * @param DHLStructVersion $_version
     * @param DHLStructShipmentNumberType $_shipmentNumber
     * @return DHLStructDoManifestDDRequest
     */
