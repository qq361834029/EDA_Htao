<?php
/**
 * File for CorreosWsdlClass to communicate with SOAP service
 * @package Correos
 ...
 */
/**
 * CorreosWsdlClass to communicate with SOAP service
 * 
 * @package Correos
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-10-17
 */
class CorreosWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'var/wsdltophp.com/storage/wsdls/5b3b2a7cf5ba55358da1651b1211f84d/wsdl.xml';
    /**
    ...
    /**
     * Constructor
     * @uses CorreosWsdlClass::setLastError()
     * @uses CorreosWsdlClass::initSoapClient()
     * @uses CorreosWsdlClass::initInternArrayToIterate()
     * @uses CorreosWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'CorreosWsdlClass'))
            {
     ...
     * @uses CorreosClassMap::classMap()
     * @uses CorreosWsdlClass::getDefaultWsdlOptions()
     * @uses CorreosWsdlClass::getSoapClientClassName()
     * @uses CorreosWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('CorreosClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = CorreosClassMap::classMap();
     ...
     * If a class is named as {Correos}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('CorreosSoapClient') && is_subclass_of('CorreosSoapClient','SoapClient'))
            return 'CorreosSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses CorreosWsdlClass::WSDL_CACHE_WSDL
     * @uses CorreosWsdlClass::WSDL_COMPRESSION
     * @uses CorreosWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses CorreosWsdlClass::WSDL_ENCODING
     * @uses CorreosWsdlClass::WSDL_EXCEPTIONS
     * @uses CorreosWsdlClass::WSDL_FEATURES
     * @uses CorreosWsdlClass::WSDL_LOGIN
     * @uses CorreosWsdlClass::WSDL_PASSWORD
     * @uses CorreosWsdlClass::WSDL_SOAP_VERSION
     * @uses CorreosWsdlClass::WSDL_STREAM_CONTEXT
     * @uses CorreosWsdlClass::WSDL_TRACE
     * @uses CorreosWsdlClass::WSDL_TYPEMAP
     * @uses CorreosWsdlClass::WSDL_URL
     * @uses CorreosWsdlClass::VALUE_WSDL_URL
     * @uses CorreosWsdlClass::WSDL_USER_AGENT
     * @uses CorreosWsdlClass::WSDL_PROXY_HOST
     * @uses CorreosWsdlClass::WSDL_PROXY_PORT
     * @uses CorreosWsdlClass::WSDL_PROXY_LOGIN
     * @uses CorreosWsdlClass::WSDL_PROXY_PASSWORD
     * @uses CorreosWsdlClass::WSDL_LOCAL_CERT
     * @uses CorreosWsdlClass::WSDL_PASSPHRASE
     * @uses CorreosWsdlClass::WSDL_AUTHENTICATION
     * @uses CorreosWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses CorreosWsdlClass::getSoapClient()
     * @uses CorreosWsdlClass::getFormatedXml()
     ...
     * @uses CorreosWsdlClass::getSoapClient()
     * @uses CorreosWsdlClass::convertStringHeadersToArray()
     ...
     * @uses CorreosWsdlClass::getInternArrayToIterate()
     * @uses CorreosWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses CorreosWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses CorreosWsdlClass::getInternArrayToIterateOffset()
     * @uses CorreosWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses CorreosWsdlClass::getInternArrayToIterateOffset()
     * @uses CorreosWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see CorreosWsdlClass::offsetGet()
     * @uses CorreosWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses CorreosWsdlClass::getAttributeName()
     * @uses CorreosWsdlClass::__toString()
     * @uses CorreosWsdlClass::_set()
     * @uses CorreosWsdlClass::_get()
     * @uses CorreosWsdlClass::setInternArrayToIterate()
     * @uses CorreosWsdlClass::setInternArrayToIterateIsArray()
     * @uses CorreosWsdlClass::setInternArrayToIterateOffset()
