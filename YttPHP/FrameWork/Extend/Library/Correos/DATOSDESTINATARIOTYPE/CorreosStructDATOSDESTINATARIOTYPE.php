<?php
/**
 * File for class CorreosStructDATOSDESTINATARIOTYPE
 * @package Correos
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CorreosStructDATOSDESTINATARIOTYPE originally named DATOSDESTINATARIOTYPE
 ...
 * @date 2016-10-17
 */
class CorreosStructDATOSDESTINATARIOTYPE extends CorreosWsdlClass
{
    /**
     * The Identificacion
     ...
     * CorreosStructDIRECCIONTYPE $_datosDireccion2
     * string $_cP
     * string $_zIP
     * string $_pais
     ...
     * @param CorreosStructDIRECCIONTYPE $_datosDireccion2 the DatosDireccion2
     * @return CorreosStructDIRECCIONTYPE
     */
    public function setDatosDireccion2($_datosDireccion2)
    {
        return ($this->DatosDireccion2 = $_datosDireccion2);
    }
    /**
     * Get CP value
     * @return string|null
