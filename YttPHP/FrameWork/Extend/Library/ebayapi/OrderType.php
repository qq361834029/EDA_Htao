...
/**
 * There are single line item orders (traditionally known as transactions) 
 * andmultiple line item (Combined Payment) orders. A single payment is made for 
 * bothorder types.<br><br>We strongly recommend that you avoid mixing digital and 
 * non-digital listings inthe same Combined Payment order. (In the future, AddOrder 
 * may enforce this recommendation). 
 *
