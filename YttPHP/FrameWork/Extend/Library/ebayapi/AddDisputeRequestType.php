...
/**
 * Enables a seller to create a new Unpaid Item dispute. The Item Not Received 
 * andSignificantly Not as Described buyer disputes can only be created via the 
 * eBayWeb site. 
 *
