...
/**
 * Contains information about a single order line item (transaction). An orderline 
 * item contains information about the sale of one or multipleitems from a single 
 * listing to a single buyer. The eBay system creates an orderline item when a 
 * buyer has committed to make a purchase in anauction or fixed-price listing. A 
 * fixed-priced listing (with multiple identicalitems or a similar item with 
 * variations) can spawn one or more order line items. Auction and single-item, 
 * fixed-price listings can only spawnone order line item.<br> 
 *
