...
{//类定义开始
     ...
     */
     protected $OUTDATE;     
     protected $OUTDATE_TYPE	=	array(''=>'%Y-%m-%d','zh'=>'%Y-%m-%d','eur'=>'%d/%m/%y');     
...
//        $this->YMD          =   $this->format("%Y%m%d");  //简单日期  
		$this->OUTDATE      =   $this->format($this->OUTDATE_TYPE[C('digital_format')]);  //简单日期
    ...
    public function getFormat($date) {
        ...
        $this->setDate($this->date); 
        return $this->format("%H:%M:%S")!='00:00:00' ? $this->OUTDATE.' '.$this->CTIME : $this->OUTDATE;   	 
    }
