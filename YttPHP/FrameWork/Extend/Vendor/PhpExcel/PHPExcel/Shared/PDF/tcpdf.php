...
/**
 * main configuration file 主要的配置文件 
 */
...
/**
 * unicode data unicode数据
 */
require_once(dirname(__FILE__).'/unicode_data.php');

/**
 * html colors table HTML颜色表
 */
require_once(dirname(__FILE__).'/htmlcolors.php');

if (!class_exists('TCPDF', false)) {
	/**
	 * define default PDF document producer 定义默认的PDF文档制作人
	 */ 
	...
	*/
	class TCPDF {
		...
		/**
		* @var current page number 当前页码
		* @access protected
		*/
		protected $page;
		
		/**
		* @var current object number 当前对象的数量
		* @access protected
		*/
		protected $n;

		/**
		* @var array of object offsets 对象偏移量数组
		* @access protected
		*/
		protected $offsets;

		/**
		* @var buffer holding in-memory PDF 缓存在内存的pdf
		* @access protected
		*/
		protected $buffer;
		...
		*/
		...
		/**
		* @var current document state 当前文档的状态
		* @access protected
		*/
		protected $state;

		/**
		* @var compression flag 压缩标志
		* @access protected
		*/
		protected $compress;
		
		/**
		* @var current page orientation (P = Portrait, L = Landscape) 当前页面方向（P =纵向，L =横向）
		* @access protected
		*/
		...
		*/
		...
		/**
		* @var scale factor (number of points in user unit) 比例因子(用户使用单位与磅之间的转化比例)
		* @access protected
		*/
		protected $k;

		/**
		* @var width of page format in points 页面宽度(单位：磅)
		* @access protected
		*/
		protected $fwPt;

		/**
		* @var height of page format in points 页面高度(单位：磅)
		* @access protected
		*/
		protected $fhPt;

		/**
		* @var current width of page in points 当前页面宽度(单位：磅)
		* @access protected
		*/
		protected $wPt;

		/**
		* @var current height of page in points 当前页面高度(单位：磅)
		* @access protected
		*/
		protected $hPt;

		/**
		* @var current width of page in user unit 当前页面宽度(单位：用户设定)
		* @access protected
		*/
		protected $w;

		/**
		* @var current height of page in user unit 当前页面高度(单位：用户设定)
		* @access protected
		*/
		protected $h;
		...
		*/
		...
		/**
		* @var right margin 右边距
		* @access protected
		*/
		protected $rMargin;

		/**
		* @var page break margin 分页边距
		* @access protected
		*/
		protected $bMargin;

		/**
		* @var cell internal padding 单元格内边距
		* @access protected
		*/
		//protected
		public $cMargin;
		...
		/**
		* @var cell internal padding (previous value) 旧的单元格内边距
		* @access protected
		*/
		protected $oldcMargin;

		/**
		* @var current horizontal position in user unit for cell positioning 单元格水平定位(按用户设定单位衡量)
		* @access protected
		*/
		protected $x;

		/**
		* @var current vertical position in user unit for cell positioning 单元格垂直定位(按用户设定单位衡量)
		* @access protected
		*/
		protected $y;

		/**
		* @var height of last cell printed 最后一个印刷单元格高度
		* @access protected
		*/
		protected $lasth;

		/**
		* @var line width in user unit 行宽(按用户设定单位衡量)
		* @access protected
		*/
		protected $LineWidth;

		/**
		* @var array of standard font names 标准字体名称数组
		* @access protected
		*/
		protected $CoreFonts;

		/**
		* @var array of used fonts 常用字体数组
		* @access protected
		*/
		protected $fonts = array();

		/**
		* @var array of font files 字体文件数组
		* @access protected
		*/
		protected $FontFiles = array();

		/**
		* @var array of encoding differences 差异编码数组
		* @access protected
		*/
		protected $diffs = array();

		/**
		* @var array of used images 图片数组
		* @access protected
		*/
		protected $images = array();

		/**
		* @var array of Annotations in pages 页面批注数组
		* @access protected
		*/
		protected $PageAnnots = array();

		/**
		* @var array of internal links 内部链接数组
		* @access protected
		*/
		protected $links = array();

		/**
		* @var current font family 当前字体
		* @access protected
		*/
		protected $FontFamily;

		/**
		* @var current font style 当前字体样式
		* @access protected
		*/
		protected $FontStyle;
		
		/**
		* @var current font ascent (distance between font top and baseline) 当前字体上间距 (字体上方和基线之间的距离)
		* @access protected
		...
		*/
		...
		/**
		* @var current font descent (distance between font bottom and baseline) 当前字体下间距 (字体下方和基线之间的距离)
		* @access protected
		* @since 2.8.000 (2007-03-29)
		*/
		...
		/**
		* @var underlining flag 下划线标志
		* @access protected
		*/
		protected $underline;

		/**
		* @var current font info 当前字体信息
		* @access protected
		*/
		protected $CurrentFont;

		/**
		* @var current font size in points 当前字体大小(单位：磅)
		* @access protected
		*/
		protected $FontSizePt;

		/**
		* @var current font size in user unit 当前字体大小(单位：用户设定)
		* @access protected
		*/
		protected $FontSize;

		/**
		* @var commands for drawing color 绘制颜色
		* @access protected
		*/
		protected $DrawColor;

		/**
		* @var commands for filling color 填充颜色
		* @access protected
		*/
		protected $FillColor;

		/**
		* @var commands for text color 文本颜色
		* @access protected
		*/
		protected $TextColor;

		/**
		* @var indicates whether fill and text colors are different 显示填充和文本颜色是否不同标志
		* @access protected
		*/
		protected $ColorFlag;

		/**
		* @var automatic page breaking 自动分页
		* @access protected
		*/
		protected $AutoPageBreak;

		/**
		* @var threshold used to trigger page breaks 触发分页的阈值
		* @access protected
		*/
		...
		*/
		...
		/**
		* @var zoom display mode 缩放模式
		* @access protected
		*/
		protected $ZoomMode;

		/**
		* @var layout display mode 布局模式
		* @access protected
		*/
		...
		*/
		...
		/**
		* @var alias for total number of pages 总页数别名
		* @access protected
		*/
		protected $AliasNbPages = '{nb}';
		
		/**
		* @var alias for page number 页码别名
		* @access protected
		*/
		protected $AliasNumPage = '{pnb}';
		
		/**
		* @var right-bottom corner X coordinate of inserted image 插入图像的右下角X坐标
		* @since 2002-07-31
		* @author Nicola Asuni
		* @access protected
		*/
		...
		/**
		* @var right-bottom corner Y coordinate of inserted image 插入图像的右下角Y坐标
		* @since 2002-07-31
		* @author Nicola Asuni
		* @access protected
		*/
		...
		/**
		* @var adjusting factor to convert pixels to user units. 像素转换为用户单位的调整系数。
		* @since 2004-06-14
		* @author Nicola Asuni
		* @access protected
		*/
		...
		/**
		* @var boolean set to true when the input text is unicode (require unicode fonts) 当输入的文本是unicode设置为true（需要Unicode字体）
		* @since 2005-01-02
		* @author Nicola Asuni
		* @access protected
		*/
		...
		*/
		...
		/**
		 * @var Minimum distance between header and top page margin. 页眉和顶部页边距之间的最小距离。
		 * @access protected
		 */
		protected $header_margin;
		
		/**
		 * @var Minimum distance between footer and bottom page margin. 页脚和底部页边距之间的最小距离。
		 * @access protected
		 */
		protected $footer_margin;
		
		/**
		 * @var original left margin value 原始左边距值
		 * @access protected
		 * @since 1.53.0.TC013
		 */
		...
		/**
		 * @var original right margin value 原始右边距值
		 * @access protected
		 * @since 1.53.0.TC013
		 */
		...
		/**
		 * @var Header font. 页眉字体
		 * @access protected
		 */
		protected $header_font;
		
		/**
		 * @var Footer font. 页脚字体
		 * @access protected
		 */
		protected $footer_font;
		
		/**
		 * @var Language templates. 语言模板
		 * @access protected
		 */
		protected $l;
		
		/**
		 * @var Barcode to print on page footer (only if set). 是否在页脚打印条码
		 * @access protected
		 */
		protected $barcode = false;
		
		/**
		 * @var If true prints header 是否打印页眉
		 * @access protected
		 */
		protected $print_header = true;
		
		/**
		 * @var If true prints footer. 是否打印页脚
		 * @access protected
		 */
		protected $print_footer = true;
			
		/**
		 * @var Header image logo. 页眉logo
		 * @access protected
		 */
		protected $header_logo = '';
		
		/**
		 * @var Header image logo width in mm. 页眉logo宽度(单位：毫米)
		 * @access protected
		 */
		protected $header_logo_width = 30;
		
		/**
		 * @var String to print as title on document header. 页眉文档标题
		 * @access protected
		 */
		protected $header_title = '';
		
		/**
		 * @var String to print on document header. 页眉内容
		 * @access protected
		 */
		protected $header_string = '';
		
		/**
		 * @var Default number of columns for html table. 默认分栏数量
		 * @access protected
		 */
		...
		/**
		 * @var HTML PARSER: array to store current link and rendering styles. HTML解析器：存储当前链接和渲染样式数组
		 * @access protected
		 */
		protected $HREF = array();
		
		/**
		 * @var store a list of available fonts on filesystem. 可用于存储到文件系统中的字体列表。
		 * @access protected
		 */
		protected $fontlist = array();
		
		/**
		 * @var current foreground color 当前前景色
		 * @access protected
		 */
		protected $fgcolor;
						
		/**
		 * @var HTML PARSER: array of boolean values, true in case of ordered list (OL), false otherwise. HTML解析器：布尔值的数组，如遇有序列表（OL）为true，否则为false。
		 * @access protected
		 */
		...
		/**
		 * @var HTML PARSER: current list nesting level. HTML解析器：当前列表嵌套层数。
		 * @access protected
		 */
		protected $listnum = 0;
		
		/**
		 * @var HTML PARSER: indent amount for lists. HTML解析器：缩进量列表。
		 * @access protected
		 */
		protected $listindent;
		
		/**
		 * @var current background color 当前背景色
		 * @access protected
		 */
		protected $bgcolor;
		
		/**
		 * @var Store temporary font size in points. 缓存字体磅数
		 * @access protected
		 */
		protected $tempfontsize = 10;
		
		/**
		 * @var spacer for LI tags. li标签间隔
		 * @access protected
		 */
		protected $lispacer = '';
		
		/**
		 * @var default encoding 默认编码格式
		 * @access protected
		 * @since 1.53.0.TC010
		 */
		...
		/**
		 * @var PHP internal encoding PHP内部编码
		 * @access protected
		 * @since 1.53.0.TC016
		 */
		...
		/**
		 * @var indicates if the document language is Right-To-Left 文字方向是否从右到左
		 * @access protected
		 * @since 2.0.000
		 */
		protected $rtl = false;
		...
		/**
		 * Indicates whether document is protected 文件是否是受保护的
		 * @access protected
		...
		/**
		 * last RC4 key encrypted (cached for optimisation) 最后一次加密的RC4密钥（缓存优化）
		 * @access protected
		 * @since 2.0.000 (2008-01-02)
		 */
		...
		/**
		 * last RC4 computed key 最后一次计算的RC4密钥
		 * @access protected
		 * @since 2.0.000 (2008-01-02)
		 */
		...
		/**
		 * Dot Per Inch Document Resolution (do not change) 文档分辨率每英寸点数（不要更改）
		 * @access protected
		...
		/**
		 * Restrict the rendering of some elements to screen or printout. 限制某些元素在屏幕或打印输出的渲染。
		 * @access protected
		 * @since 3.0.000 (2008-03-27)
		 */
		...
		/**
		 * Array of transparency objects and parameters. 对象透明度和参数数组
		 * @access protected
		 * @since 3.0.000 (2008-03-27)
		 */
		...
		/**
		 * Set the default JPEG compression quality (1-100) 设置默认的JPEG压缩质量（1-100）
		 * @access protected
		 * @since 3.0.000 (2008-03-27)
		 */
		...
		/**
		 * Default cell height ratio. 默认单元格高度比率
		 * @access protected
		...
		/**
		 * PDF viewer preferences. PDF阅读器首选项
		 * @access protected
		...
		/**
		 * A name object specifying how the document should be displayed when opened. 指定文档打开方式
		 * @access protected
		 * @since 3.1.000 (2008-06-09)
		 */
		protected $PageMode;
		...
		/**
		 * Array for storing gradient information. 梯度信息数组
		 * @access protected
		 * @since 3.1.000 (2008-06-09)
		 */
		...
		public function setPageFormat($format, $orientation='P') {
			...
			if (is_string($format)) {
				...
				switch (strtoupper($format)) {
					...
					case 'PRODUCT_BARCODE' : {$pf = array(  212.60, 70.87); break;}
				}
				$this->fwPt = $format[0];
				$this->fhPt = $format[1];
			} else {
		...
		*/
		...
		/**
		* Returns the current page number. 获取当前页码
		* @return int page number
		* @access public
		* @since 1.0
		...
		*/
		...
		/**
		* Sets the font used to print character strings. 设置字体
		...
		*/
		...
		/**
		* Defines the size of the current font. 设置当前字体大小
		...
		*/
		...
		/**
		* Removes SHY characters from text. 过滤文本中的SHY字符
		...
		*/
		...
		/**
		* This method allows printing text with line breaks.  这种方法允许使用换行打印文本
		...
		*/
		...
		/**
		* Get the border mode accounting for multicell position (opens bottom side of multicell crossing pages) 获取多单元格边界占据位置模式 (开启了多单元格跨页)
		* @param mixed $border Indicates if borders must be drawn around the cell block. The value can be either a number:<ul><li>0: no border (default)</li><li>1: frame</li></ul>or a string containing some or all of the following characters (in any order):<ul><li>L: left</li><li>T: top</li><li>R: right</li><li>B: bottom</li></ul>
		...
		*/
		...
		/**
		* This method returns the estimated number of lines required to print the text. 打印文本所需行数估计
		...
		*/
		...
		/**
		* This method prints text from the current position.<br /> 从当前位置打印文本
		...
		*/
		...
		/**
		* Returns the remaining width between the current position and margins. 返回当前位置与边距之间的剩余宽度
		...
		*/
		...
		/**
		* Puts an image in the page. 输出图像到页面中
		...
		*/
		...
		/**
		* Convert the loaded php image to a JPEG and then return a structure for the PDF creator. 图像转换成jpeg格式
		...
		*/
		...
		/**
		* Extract info from a JPEG file without using the GD library. 提取jpeg图像信息(配合GD库使用)
		...
		*/
		...
		/**
		* Extract info from a PNG file without using the GD library. 提取png图像信息(配合GD库使用)
		* @param string $file image file to parse
		* @return array structure containing the image data
		* @access protected
		*/
		...
		/**
		* Binary-safe and URL-safe file read. 二进制安全和URL安全读取文件
		...
		*/
		...
		/**
		* Extract info from a PNG image with alpha channel using the GD library. png图像透明度(配合GD库使用)
		* @param string $file Name of the file containing the image.
		* @param float $x Abscissa of the upper-left corner.
		* @param float $y Ordinate of the upper-left corner.
		* @param float $w Width of the image in the page. If not specified or equal to zero, it is automatically calculated.
		...
		*/
		...
		/**
		* Correct the gamma value to be used with GD library 修正伽马值 配合GD库使用
		...
		*/
		...
		/**
		* Returns the relative X value of current position. 获取横坐标
		...
		*/
		...
		/**
		* Returns the absolute X value of current position. 获取当前横坐标绝对值
		* @return float
		* @access public
		* @since 1.2
		* @see SetX(), GetY(), SetY()
		*/
		...
		/**
		* Returns the ordinate of the current position. 返回当前位置的纵坐标
		* @return float
		* @access public
		* @since 1.0
		* @see SetY(), GetX(), SetX()
		*/
		...
		/**
		* Defines the abscissa of the current position. 设置横坐标
		...
		*/
		...
		/**
		* Moves the current abscissa back to the left margin and sets the ordinate. 设置纵坐标
		...
		*/
		...
		/**
		* Defines the abscissa and ordinate of the current position. 定义当前位置的横坐标和纵坐标。
		...
		*/
		...
		/**
		* Send the document to a given destination: string, local file or browser. 发送文件到指定目的地：字符串，本地文件或浏览器
		...
		*/
		...
		/**
		* Output referencees to page annotations 输出引注
		...
		*/
		...
		/**
		* Output object dictionary for images. 输出图像对象字典
		* @access protected
		*/
		...
		/**
		* Output Resources Dictionary. 输出资源字典
		* @access protected
		*/
		...
		*/
		...
		/**
		* Adds some Metadata information 添加meta信息
		...
		*/
		...
		/**
		* Output viewer preferences. 输出查看器首选项。
		* @author Nicola asuni
		* @since 3.1.000 (2008-06-09)
		* @access protected
		*/
		...
		*/
		...
		/**
		* Output end of document (EOF). 输出文档结束标记
		* @access protected
		*/
		...
		/**
		* Initialize a new page. 初始化一个新页面
		* @param string $orientation page orientation. Possible values are (case insensitive):<ul><li>P or PORTRAIT (default)</li><li>L or LANDSCAPE</li></ul>
		* @param mixed $format The format used for pages. It can be either one of the following values (case insensitive) or a custom format in the form of a two-element array containing the width and the height (expressed in the unit given by unit).<ul><li>4A0</li><li>2A0</li><li>A0</li><li>A1</li><li>A2</li><li>A3</li><li>A4 (default)</li><li>A5</li><li>A6</li><li>A7</li><li>A8</li><li>A9</li><li>A10</li><li>B0</li><li>B1</li><li>B2</li><li>B3</li><li>B4</li><li>B5</li><li>B6</li><li>B7</li><li>B8</li><li>B9</li><li>B10</li><li>C0</li><li>C1</li><li>C2</li><li>C3</li><li>C4</li><li>C5</li><li>C6</li><li>C7</li><li>C8</li><li>C9</li><li>C10</li><li>RA0</li><li>RA1</li><li>RA2</li><li>RA3</li><li>RA4</li><li>SRA0</li><li>SRA1</li><li>SRA2</li><li>SRA3</li><li>SRA4</li><li>LETTER</li><li>LEGAL</li><li>EXECUTIVE</li><li>FOLIO</li></ul>
		* @access protected
		*/
		...
		*/
		...
		/**
		* Begin a new object and return the object number. 新建一个对象并返回其编号
		...
		*/
		...
		/**
		* Underline for rectangular text area. 矩形文本区域下划线
		* @param int $x X coordinate
		* @param int $y Y coordinate
		...
		*/
		...
		/**
		* Line through for rectangular text area. 矩形文本区域删除线
		* @param int $x X coordinate
		* @param int $y Y coordinate
		* @param string $txt text to linethrough
		* @access protected
		...
		*/
		...
		/**
		* Read a 4-byte integer from file. 从文件中读取4个整型字节
		...
		*/
		...
		/**
		* Returns a formatted date for meta information 格式化meta信息中的日期
		...
		*/
		...
		/**
		* Format a text string for meta information 格式化meta信息中的文本字符串
		* @param string $s string to escape.
		* @return string escaped string.
		* @access protected
		*/
		...
		*/
		...
		/**
		* Output a string to the document. 输出字符串到文档
		* @param string $s string to output.
		* @access protected
		*/
		...
		/**
		 * Converts pixels to User's Units. 像素转化为用户单位
		 * @param int $px pixels
		...
		*/
		...
		/**
		 * Put encryption on PDF document. pdf文档加密
		 * @access protected
		 * @since 2.0.000 (2008-01-02)
		 */
		...
		*/
		...
		/**
		* Encrypts a string using MD5 and returns it's value as a binary string. 获取指定字符串的MD5加密后的二进制字符串
		...
		*/
		...
		/**
		* Set document protection 设置文档保护
		...
		*/
		...
		/**
		* Vertical and horizontal proportional Scaling. 纵向和横向的按比例缩放
		...
		*/
		...
		/**
		* Vertical and horizontal non-proportional Scaling. 纵向和横向的不按比例缩放
		* @param float $s_x scaling factor for width as percent. 0 is not allowed.
		* @param float $s_y scaling factor for height as percent. 0 is not allowed.
		* @param int $x abscissa of the scaling center. Default is current x position
		* @param int $y ordinate of the scaling center. Default is current y position
		...
		*/
		...
		/**
		* Point reflection mirroring. 点镜像映射
		* @param int $x abscissa of the point. Default is current x position
		* @param int $y ordinate of the point. Default is current y position
		* @access public
		* @since 2.1.000 (2008-01-07)
		...
		*/
		...
		/**
		* Translate graphic object horizontally. 图形对象水平方向平移
		...
		*/
		...
		/**
		* Translate graphic object vertically. 图形对象垂直方向平移
		...
		*/
		...
		/**
		* Translate graphic object horizontally and vertically. 图形对象平移
		...
		*/
		...
		/**
		* Apply graphic transformations. 图像变换
		* @access protected
		* @since 2.1.000 (2008-01-07)
		* @see StartTransform(), StopTransform()
		*/
		...
		*/
		...
		/**
		* Returns the current the line width. 返回当前线条宽度
		...
		*/
		...
		/*
		* Draws a line from last draw point. 从最后一个绘制点开始绘制一条线段
		...
		*/
		...
		/*
		* Draws a Bezier curve from last draw point. 从最后一个绘制点开始绘制贝塞尔曲线
		...
		*/
		...
		/**
		* Draws a line between two points. 绘制线段
		...
		*/
		...
		/**
		* Draws a poly-Bezier curve. 绘制多聚贝赛尔曲线
		...
		*/
		...
		/**
		* Draws a regular polygon. 绘制正多边形
		* @param float $x0 Abscissa of center point.
		* @param float $y0 Ordinate of center point.
		...
		*/
		...
		/**
		* Draws a rounded rectangle. 绘制圆角矩形。
		...
		*/
		...
		/*
		* Create a bookmark PDF string. 创建pdf书签
		* @access protected
		* @author Olivier Plathey, Nicola Asuni
		* @since 2.1.002 (2008-02-12)
		*/
		...
		*/
		...
		/*
		* Convert color to javascript color. 转化颜色设置为js颜色设置
		...
		*/
		...
		/*
		* Adds a javascript form field. 添加一个表单字段的js代码
		...
		*/
		...
		/*
		* Set default properties for form fields. 设置表单默认属性
		* @param array $prop javascript field properties. Possible values are described on official Javascript for Acrobat API reference.
		* @access public
		* @author Nicola Asuni
		* @since 4.8.000 (2009-09-06)
		*/
		...
		/*
		* Return the default properties for form fields. 获取表单的默认属性
		...
		*/
		...
		/*
		* Creates a RadioButton field 生成一个单选按钮
		* @param string $name field name
		* @param int $w width
		* @param array $prop javascript field properties. Possible values are described on official Javascript for Acrobat API reference.
		* @param array $opt annotation parameters. Possible values are described on official PDF32000_2008 reference.
		...
		*/
		...
		/*
		* Creates a List-box field 生成一个列表框
		* @param string $name field name
		* @param int $w width
		* @param int $h height
		...
		*/
		...
		/*
		* Creates a Combo-box field 生成一个组合框
		* @param string $name field name
		* @param int $w width
		* @param int $h height
		* @param array $values array containing the list of values.
		...
		*/
		...
		/*
		* Creates a CheckBox field 生成一个复选框
		* @param string $name field name
		* @param int $w width
		* @param boolean $checked define the initial state.
		* @param array $prop javascript field properties. Possible values are described on official Javascript for Acrobat API reference.
		...
		*/
		...
		/*
		* Add certification signature (DocMDP or UR3) 添加认证签名
		...
		*/
		...
		/*
		* Set User's Rights for PDF Reader 设置用户pdf阅读权限
		...
		*/
		...
		/*
		* Enable document signature (requires the OpenSSL Library). 启用文档签名（需要OpenSSL库）。 
		...
		*/
		...
		/**
		* Defines an alias for the total number of pages. 定义总页码别名
		...
		*/
		...
		/**
		 * Returns the string alias used for the total number of pages. 返回总页码别名
		...
		*/
		...
		/**
		* Defines an alias for the page number. 定义页码别名
		* It will be substituted as the document is closed.
		* @param string $alias The alias.
		* @access public
		* @since 4.5.000 (2009-01-02)
		...
		*/
		...
		/**
		 * Returns the string alias used for the page number. 返回页码别名
         * If the current font is unicode type, the returned string is surrounded by additional curly braces.
		 * @return string
		 * @access public
		 * @since 4.5.000 (2009-01-02)
		...
		*/
		...
		/**
		* Returns the current group page number formatted as a string. 返回当前组的格式化页码字符串
		* @access public
		...
		*/
		...
		/*
		 * Return the alias of the current page group 返回当前页面组别名
         * If the current font is unicode type, the returned string is surrounded by additional curly braces.
		...
		*/
		...
		/*
		 * Return the alias for the page number on the current page group 返回页码在当前页面组的别名
         * If the current font is unicode type, the returned string is surrounded by additional curly braces.
		 * (will be replaced by the total number of pages in this group).
		 * @return alias of the current page group
		 * @access public
		...
		*/
        ...
        /**
		* Returns the current page number formatted as a string. 返回当前页面格式化字符串
		* @access public
		* @since 4.2.005 (2008-11-06)
		* @see PaneNo(), formatPageNumber()
		*/
		...
		*/
		...
		/*
		* Set the visibility of the successive elements. 设置元素可见性
		...
		*/
		...
		/*
		* Set alpha for stroking (CA) and non-stroking (ca) operations. 设置滤镜Alpha属性
		...
		*/
		...
		/*
		* Set the default JPEG compression quality (1-100) 设置jpeg图像压缩质量(1-100)
		...
		*/
		...
		/*
		* Set the default number of columns in a row for HTML tables. 设置表格默认列数
		...
		*/
		...
		/*
		* Set the height of the cell (line height) respect the font height. 设置行高
		...
		*/
		...
		/*
		* return the height of cell repect font height. 获取行高
		* @access public
		* @since 4.0.012 (2008-07-24)
		*/
		...
		*/
		...
		/**
		* Paints a linear colour gradient. 沿直线绘制颜色渐变
		...
		*/
		...
		/**
		* Paints a radial colour gradient. 沿径向绘制颜色渐变
		* @param float $x abscissa of the top left corner of the rectangle.
		* @param float $y ordinate of the top left corner of the rectangle.
		* @param float $w width of the rectangle.
		* @param float $h height of the rectangle.
		...
		*/
		...
		/**
		* Paints a coons patch mesh. 绘制Coons曲面网格
		* @param float $x abscissa of the top left corner of the rectangle.
		* @param float $y ordinate of the top left corner of the rectangle.
		* @param float $w width of the rectangle.
		* @param float $h height of the rectangle.
		...
		*/
		...
		/**
		* Set a rectangular clipping area. 设置矩形裁剪区域。
		...
		*/
		...
		/**
		* Draw the sector of a circle. 绘制饼图扇区
		...
		*/
		...
		/**
	 	 * This function is DEPRECATED, please use the new write1DBarcode() function. 打印条形码(不推荐使用，请改用write1DBarcode函数)
		 * @param int $x x position in user units
		 * @param int $y y position in user units
		 * @param int $w width in user units
		...
		/**
		 * Returns an array containing current margins: 返回容器当前边距信息
		 * <ul>
		...
		/**
		 * Returns an array containing original margins: 返回容器原始边距信息
		 * <ul>
				<li>$ret['left'] = left  margin</li>
				<li>$ret['right'] = right margin</li>
		 * </ul>
		...
		/**
		 * Returns the current font size. 返回当前字体大小
		...
		/**
		 * Returns the current font size in points unit. 返回当前字体大小(单位：磅)
		...
		/**
		 * Returns the current font family name. 返回当前字体集名称
		...
		/**
		 * Returns the current font style. 返回当前字体样式
	...
	Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
		...
		/**
		 * Add vertical spaces if needed. 增加垂直间距
		...
		/**
		 * Set the default bullet to be used as LI bullet symbol 设置li标签默认项目符号
		...
		/**
		* Set the booklet mode for double-sided pages. 设置双页模式
		...
		*/
		...
		/**
		* Swap the left and right margins. 互换左右间距
		...
		*/
		...
		/**
		* Set the vertical spaces for HTML tags. 设置html标签的上下间距
		...
		*/
        ...
        /**
		* Set custom width for list indentation. 自定义列表缩进宽度
		...
		*/
        ...
        /**
		* Set the top/bottom cell sides to be open or closed when the cell cross the page. 设置跨页单元格在页面顶部/顶部是否显示闭合边框
		...
		*/
        ...
        /**
		* Set the color and font style for HTML links. 设置html链接样式
		...
		*/
        ...
        /**
		* convert html string containing value and unit of measure to user's units or points. 将html字符串中的计量单位值转换为用户设定单位或磅
		...
		*/
		...
		/**
		* Returns the Roman representation of an integer number 返回整数的罗马数字格式
		...
		*/
		...
		/**
		* Output an HTML list bullet or ordered item symbol 输出列表项目符号
		...
		*/
        ...
        /**
		* Returns current graphic variables as array. 返回当前图像设置
		...
		*/
		...
		/**
		* Returns a temporary filename for caching object on filesystem. 获取缓存文件对象
		...
		*/
        ...
        /**
		* Writes data to a temporary file on filesystem. 写入文件缓存
		...
		*/
        ...
        /**
		* Read data from a temporary file on filesystem. 读取文件缓存
		* @param string $file file name
		...
		*/
		...
		/**
		* Set buffer content (always append data). 设置缓存
		...
		*/
        ...
        /**
		* Set page buffer content. 设置页面缓存
		...
		*/
        ...
        /**
		* Get page buffer content. 获取页面缓存
		* @param int $page page number
		...
		*/
        ...
        /**
		* Set image buffer content. 设置图片缓存
		...
		*/
        ...
        /**
		* Set image buffer content. 设置二级图片缓存
		* @param string $image image key
		...
		*/
        ...
        /**
		* Get image buffer content. 获取图片缓存
		* @param string $image image key
		...
		*/
		...
		/**
		* Set font buffer content. 设置字体缓存
		...
		*/
        ...
        /**
		* Set font buffer content. 设置二级字体缓存
		* @param string $font font key
		...
		*/
        ...
        /**
		* Get font buffer content. 获取字体缓存
		* @param string $font font key
		...
		*/
        ...
        /**
		* Move a page to a previous position. 移动指定页面到另一个指定页面之前
		...
		*/
        ...
        /**
		* Remove the specified page. 删除指定页面
		...
		*/
		...
		/**
		* Stores a copy of the current TCPDF object used for undo operation. 启动事务
		* @access public
		* @since 4.5.029 (2009-03-19)
		*/
		...
		/**
		* Delete the copy of the current TCPDF object used for undo operation. 提交事务
		* @access public
		* @since 4.5.029 (2009-03-19)
		*/
		...
		/**
		* This method allows to undo the latest transaction by returning the latest saved TCPDF object with startTransaction(). 回滚事务
		...
		*/
		...
		/**
		* Creates a copy of a class object 克隆对象
		...
		*/
		...
		/**
		* Determine whether a string is empty. 判断字符串是否为空
