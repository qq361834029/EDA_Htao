...
class PHPExcel_Writer_PDF extends PHPExcel_Writer_HTML implements PHPExcel_Writer_IWriter {
	...
	private static $_paperSizes = array(
		...
		'PRODUCT_BARCODE'														=> array(212.60, 70.87)	//	(75 mm by 25 mm)
	);
	 ...
	 * @var array
	 */
	private static $_PageUnits = array(
		'px',
		'pt',
		'mm',
		'cm',
	...
	public function save($pFilename = null) {
		...
		if (!is_null($this->_papeUnit) && isset(self::$_PageUnits[$printPapeUnit])) {
		    $papeUnit	= self::$_PageUnits[$this->_papeUnit];
		} else {
		    $papeUnit	= 'pt';
		}
		...
		// Create PDF
		$pdf = new TCPDF($orientation, $papeUnit, $paperSize);
