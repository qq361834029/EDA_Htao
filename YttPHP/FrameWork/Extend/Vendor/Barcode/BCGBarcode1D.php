 ...
 */
include_once(dirname(__FILE__).'/BCGArgumentException.php');
include_once(dirname(__FILE__).'/BCGBarcode.php');
include_once(dirname(__FILE__).'/BCGFontPhp.php');
include_once(dirname(__FILE__).'/BCGFontFile.php');
include_once(dirname(__FILE__).'/BCGLabel.php');
...
abstract class BCGBarcode1D extends BCGBarcode {
    ...
    protected $padding;         // 条形码间距    add by lxt
    ...
    protected function nextX() {
        $this->positionX+= $this->padding;//条形码间距修正     edit by lxt
    }
