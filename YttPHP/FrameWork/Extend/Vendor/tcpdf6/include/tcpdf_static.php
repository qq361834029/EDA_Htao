...
class TCPDF_STATIC {
	...
	public static function getPageSizeFromFormat($format) {
		// Paper cordinates are calculated in this way: (inches * 72) where (1 inch = 25.4 mm)90 80
		switch (strtoupper($format)) {
			...
			case 'PRODUCT_BARCODE'		: {$pf = array(  212.60, 70.87); break;}//75mm*25mm
            case 'INSTOCK_BARCODE'      : {$pf = array(  283.48, 170.09); break;}//100mm*60mm
		    case 'RETURNSALEORDER_BARCODE'      : {$pf = array(  240, 260); break;}
            case 'PACKBOX_BARCODE'              : {$pf = array(226.77,255.11); break;}
            case 'SALEORDER_POST_BARCODE'    : {$pf = array(158.749,85.045); break;}//56mm*30mm
            case 'SALEORDER_ITNEXIVE_BARCODE'   : {$pf = array(266.471,184.264); break;}//94mm*65mm
            case 'SALEORDER_DEFAULT_BARCODE'   : {$pf = array(283.48, 184.264); break;}//100mm*65mm
			// DEFAULT ISO A4
