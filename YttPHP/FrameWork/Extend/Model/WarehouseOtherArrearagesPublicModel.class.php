...
class WarehouseOtherArrearagesPublicModel extends FundsOtherArrearagesPublicModel {
	
	///模型名与数据表名不一致，需要指定
	public $tableName 		= 	'paid_detail';
	///款项类型
	public $object_type		=	402;///厂家其他应收款
	///对象类型
	public $comp_type		=	4;
	///列表查询的表的名字
	public $indexTableName	=	'warehouse_paid_detail'; 
