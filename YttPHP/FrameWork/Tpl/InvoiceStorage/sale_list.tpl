{detail_table flow='invoice' from=$rs.sale_detail.list barcode=false
...
<tr index="{$index}" class="{$none}">
	...
	{td tfoot_value=$rs.sale_detail.total.dml_quantity class="t_right"}
		{$item.dml_quantity}
	{/td}
	<td class="t_right">{$item.dml_price}</td>
	{td tfoot_value=$rs.sale_detail.total.dml_money class="t_right"}
		{$item.dml_money}
	{/td}
	{td type='flow_invoice_discount_money' class="t_right"}
		{$item.dml_discount}
	{/td}
	{td type='flow_invoice_discount_after_money' tfoot_value=$rs.sale_detail.total.dml_after_discount_money class="t_right"}
		{$item.dml_after_discount_money}
	{/td}
	{td tfoot_value=$rs.sale_detail.total.dml_iva_cost class="t_right"}
		{$item.dml_iva_cost}
	{/td}
	{td tfoot_value=$rs.sale_detail.total.dml_total_money class="t_right"}
