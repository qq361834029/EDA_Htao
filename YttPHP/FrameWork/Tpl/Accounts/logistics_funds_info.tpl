	<script>
	$().ready(function(){
		getFundsInfo('logistics',{C('how_assign_info')});
	})
...
//			$dom.find("[name^='check_info']").attr("checked",'true');//全选 
		...
		{if $fund.Ini neq ""}
		<tr id="show_funs_ini_tr" class="none" ><th colspan="4">{$lang.logistics_ini_info}</th></tr>   
		...
		{/if}
		{if $fund.sale neq ""}
		<tr id="show_funs_sale_tr" class="none" ><th colspan="4">{$lang.logistics_sale_info}</th></tr>   
		...
		{if $fund.other neq ""}
		<tr id="show_funs_other_tr" class="none"><th colspan="4">{$lang.logistics_other_info}</th></tr>   
		...
		{if $fund.funds neq ""}
		<tr id="show_funs_funds_tr" class="none"><th colspan="4">{$lang.logistics_funds_info}</th></tr>   
