...
{wz}
<form method="POST" action="{"ProductCheckImport/{$smarty.const.ACTION_NAME}"|U}" id="search_form">
__SEARCH_START__
{assign var="import_key" value="ProductCheckImport"}
<input type="hidden" id="flow" value="productCheckImport">
	...
	<tr>
		<td>
			...
			<ul> 
				...
				<br/>
				<li>{$lang.select_file}：
					{upload tocken=$file_tocken sid=$sid type=33 allowTypes="xls,xlsx"}
				</li>
				<br/>
				<li>
