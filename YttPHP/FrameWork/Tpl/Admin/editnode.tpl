...
<form method="POST" action="{'Admin/saveNode'|U}">
...
<tr>
	...
	<td class="tLeft" ><input type="text" name="parent_id" value="{$rs.parent_id}">
...
<tr>
	...
	<td class="tLeft" ><input type="text" name="group_id" value="{$rs.group_id}"><input type="text" name="dfsdf" url="{'/AutoComplete/node'|U}" value="{$rs.group_title}" jqac>（当前菜单显示所属关系）</td>
</tr>
<tr>
