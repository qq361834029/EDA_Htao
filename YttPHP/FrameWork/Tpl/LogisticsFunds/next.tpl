<form action="{'LogisticsFunds/insert'|U}" method="POST" onsubmit="return false">
...
<div class="add_box">
		...
		<tr>
    			<th colspan="4">{$lang.logistics_info}</th>
    	</tr>
    	<tr>
    			<td class="width15">{$lang.logistics_name}：</td>
				<td class="t_left width30">
					<input type="hidden" name="comp_id" id="comp_id" value="{$rs.comp_id}">{$rs.logistics_name} 
				</td> 
