{detail_table flow='sale' from=$rs.detail action=['view','edit'] op_show=['add','edit'] 
	thead=[$lang.product_no,$lang.product_name,'flow_color','flow_size','flow_quantity','flow_capability','flow_dozen','flow_mantissa','flow_row_total','flow_return_sale_warehouse',$lang.price,$lang.money,'flow_sale_discount','flow_sale_after_discount']}
