 {ytt_table 
	show=[
			...
			["value"=>"dd_express_api_request_status","title"=>$lang.request_status,"width"=>"16%", 'td'=>['class'=>'t_center'],'span'=>['onclick'=>"$.autoShow(this,'{$smarty.const.MODULE_NAME}', 'state_log')"],
				'hidden'=>[
					['name'=>'correos_list_id','id'=>'object_id','value'=>'id']
				]
			],
	...
	operate_show=[
		["role"=>'request','class'=>'icon icon-list-hand','url'=>"{$smarty.const.MODULE_NAME}/request", 'link_id' => ['correos_list_id' => 'id', 'request_type'=>'express_api_request_type'], 'onclick' => '$.cancel(this)']
	]
} 