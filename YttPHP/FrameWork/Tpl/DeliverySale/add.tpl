    ...
    <tbody>
         ...
         <div class="basic_tb">
          <ul> 
			...
			<input type="hidden" name="sale_order_id" id="sale_order_id" value="{$rs.id}">
		...
		<li>{$lang.delivery_date}：<input type="text" name="delivery_date"  id="delivery_date" value="{$this_time}" class="Wdate spc_input" 
