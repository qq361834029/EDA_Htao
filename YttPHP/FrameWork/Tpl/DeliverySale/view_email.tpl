...
<table cellspacing="0" cellpadding="0"  style="font-size:12px;line-height:30px;" width="99%">
    <tbody>
		...
		{/if}
          ...
          <tr><td>{include file="DeliverySale/detail_email.tpl"}</td></tr> 
          <tr><td style="padding-top:10px;">
	          <table width="100%" cellspacing="0" cellpadding="0" border="0" style="line-height:30px;font-size:12px;">
				<tbody>
					<tr> 
					<td width="12%" valign="top" style="text-align:right;" >{$lang.comments}：</td>
					<td style="text-align:left;"  width="38%" valign="top">{$rs.edit_comments}</td>
					<td style="text-align:right;" width="12%" valign="top">{$lang.receive_addr}：</td>
					<td style="text-align:left"  width="38%" valign="top">{$rs.edit_receive_addr}</td>
					</tr>
		</tbody>
		</table>
      </td></tr>                      
