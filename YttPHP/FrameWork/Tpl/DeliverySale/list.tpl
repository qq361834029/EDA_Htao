{ytt_table
	show=[
			...
			["value"=>"delivery_no","title"=>$lang.delivery_no,"link"=>["url"=>"Delivery/view","link_id"=>"id","title"=>"查看"]],
			["value"=>"orders_no","title"=>$lang.sale_no,"link"=>["url"=>"SaleOrder/view","link_id"=>['id'=>"sale_order_id"],"title"=>"查看"]],
