...
<form action="{'ClientOtherArrearages/insert'|U}" method="POST" onsubmit="return false">
    		...
    		<td colspan="4">
				...
				<ul> 
					...
					<li>
						...
						<input type="text" url="{'/AutoComplete/fundsClassName'|U}" where="{" to_hide=1 and relation_object=2 and pay_type=2 "|urlencode}" jqac>__*__ 
					</li>
					<li style="display:none;">
						...
						<input type="text" name="reserve_id" id="reserve_id" url="{'/AutoComplete/fundsRelationDocNo'|U}" where="factory_id=0"  jqac><span id="reserve_require_span">__*__</span>
					</li>
