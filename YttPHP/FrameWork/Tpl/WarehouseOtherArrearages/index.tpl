{wz}
<form method="POST" action="{'WarehouseOtherArrearages/index'|U}" id="search_form">
__SEARCH_START__
			<dl> 
					...
					<dt>
						...
						<input type="text" url="{'/AutoComplete/fundsClassName'|U}" where="{" to_hide=1 and relation_object=5 and pay_type=1 "|urlencode}" jqac>						
	            	</dt>
					<dt>
...
{include file="WarehouseOtherArrearages/list.tpl"}
</div> 
