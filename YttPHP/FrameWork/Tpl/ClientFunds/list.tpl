 {ytt_table 
	show=[
			["value"=>"factory_name","title"=>$lang.factory_name,"link"=>["url"=>"ClientFunds/view","link_id"=>['id'=>"id"]],"width"=>"10%","total_title"=>"title",'show'=>!$is_factory],
			["value"=>"w_name","title"=>$lang.warehouse_name,"width"=>"10%",'show'=>$login_user.role_type != C('WAREHOUSE_ROLE_TYPE')], 
			["value"=>"dd_paid_type","title"=>$lang.paid_type,"width"=>"10%"], 
