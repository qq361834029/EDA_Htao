{wz}
<form method="POST" action="{'LogisticsOtherArrearages/index'|U}" id="search_form">
__SEARCH_START__
			<dl> 
					<dt>
					...
					<dt>
						...
						<input type="text" url="{'/AutoComplete/fundsClassName'|U}" where="{" to_hide=1 and relation_object=4 and pay_type=1 "|urlencode}" jqac>						
	            	</dt>
					<dt>
...
{include file="LogisticsOtherArrearages/list.tpl"}
</div> 
