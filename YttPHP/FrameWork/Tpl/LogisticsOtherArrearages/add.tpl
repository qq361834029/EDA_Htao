...
<form action="{'LogisticsOtherArrearages/insert'|U}" method="POST" onsubmit="return false">
    	...
    	<tr>
    		<td colspan="4">
				...
				<ul> 
					<li>
						{$lang.logistics_name}：
						<input type="hidden" name="comp_id" id="comp_id" value="{$smarty.post.query.id}" onchange="factoryLimitFundsRelationDoc(3)" >
					...
					<li>
						...
						<input type="text" url="{'/AutoComplete/fundsClassName'|U}" where="{" to_hide=1 and relation_object=4 and pay_type=1 "|urlencode}" jqac>__*__ 
					</li>
