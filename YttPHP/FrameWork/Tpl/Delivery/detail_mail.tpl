...
<tr index="{$index}" class="{$none}" style="{$mail_style}">
	{td id="span_product" style="text-align:left;" view="product_no" width="90" viewaction=['add','edit','view']  style="text-align:left;"} 
		{$item.product_no}
	{/td}
	{td id="span_product_name" view="product_name"  style="text-align:left;"}
		{$item.product_name}
	{/td}
	{td type="flow_color" view="color_name" style="text-align:center;" width="66"  viewaction=['add','edit','view']} 
		{$item.color_name}
	{/td}
	{td type="flow_size" view="size_name" style="text-align:center;" width="46"  viewaction=['add','edit','view']}
		{$item.size_name}
	{/td} 
	...
	{$item.w_name}
	{/td}
	{td id="sum_money" class="t_center" type='flow_delivery_money' tfoot=[total_col_money=>""] total_row_money="" tfoot_value="{$rs.detail_total.dml_money}" style="text-align:right;" width="100"}
		{$item.edml_money}
	{/td} 
	{td view="dml_discount" width="46"  type="flow_delivery_discount" style="text-align:right;"}	
		{$item.edml_discount}
	{/td}
	{td  view="dml_discount_money" width="121" type="flow_delivery_after_discount" tfoot=[total_col_dis_money=>""] total_row_dis_money="" tfoot_value="{$rs.detail_total.dml_discount_money}" style="text-align:right;"}
