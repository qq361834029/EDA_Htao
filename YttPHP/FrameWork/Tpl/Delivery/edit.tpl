		...
		{/if}
          ...
          <tr><td class="pad_top_10">
	          <table width="100%" cellspacing="0" cellpadding="0" border="0">
				<tbody>
				<tr> 
					<td width="10%" valign="top">{$lang.comments}：</td>
					<td class="t_left" width="35%" valign="top"><textarea id="comments" class="textarea_height80" name="comments">{$rs.comments}</textarea></td>
					<td width="10%" valign="top">{$lang.receive_addr}：</td>
