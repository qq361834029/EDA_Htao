					...
					<ul> 
						...
						{/if}	
                            ...
                            <li>
                                ...
                                {radio data=C('YES_NO') name="storage_abnormal" id="storage_abnormal" onclick="showStorageAbnormalReason(this)"}
                            </li>
                            ...
                            <li style="display: none">
                                ...
                                {select data=C('STORAGE_ABNORMAL_REASON') name="storage_abnormal_reason" id="storage_abnormal_reason" empty=true combobox="1"}__*__
                            </li>
                            ...
                            <li>
                                ...
                                <input type="text" id="outer_pack_quantity" name="outer_pack_quantity"  value="{$rs.outer_pack_quantity}" class="spc_input" />
                                </div>
                            </li>
                            </div>
                            <div style="float: left">
                            ...
                            <li>
                                ...
                                <input type="text" id="within_pack_quantity" name="within_pack_quantity" value="{$rs.within_pack_quantity}" class="spc_input"/>
                                </div>
                            </li> 
                            </div>
					</ul>
