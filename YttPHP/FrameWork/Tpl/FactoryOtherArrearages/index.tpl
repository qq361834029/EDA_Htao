{wz}
<form method="POST" action="{'FactoryOtherArrearages/index'|U}" id="search_form">
__SEARCH_START__
			<dl> 
					<dt>
					...
					<dt>
						...
						<input type="text" url="{'/AutoComplete/fundsClassName'|U}" where="{" to_hide=1 and relation_object=3 and pay_type=1 "|urlencode}" jqac>						
	            	</dt>
					<dt>
...
{include file="FactoryOtherArrearages/list.tpl"}
</div> 
