...
<form action="{'FactoryOtherArrearages/insert'|U}" method="POST" onsubmit="return false">
    	...
    	<tr>
    		<td colspan="4">
				...
				<ul> 
					<li>
						{$lang.express_name}：
						<input type="hidden" name="comp_id" id="comp_id" value="{$smarty.post.query.id}" onchange="factoryLimitFundsRelationDoc(2)" >
						<input type="text" name="comp_name" id='comp_name' url="{'AutoComplete/expressName'|U}" jqac>__*__
					</li>
					...
					<li>
						...
						<input type="text" url="{'/AutoComplete/fundsClassName'|U}" where="{" to_hide=1 and relation_object=3 and pay_type=1 "|urlencode}" jqac>__*__ 
					</li>
