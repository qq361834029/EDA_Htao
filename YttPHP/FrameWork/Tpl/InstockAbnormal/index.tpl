{wz}
<form method="POST" action="{'InstockAbnormal/index'|U}" id="search_form">
__SEARCH_START__
...
<dl>  
	...
	<dt>
		...
		<input type="text" name="detail[like][barcode_no]" url="{'AutoComplete/instockImportBarcode'|U}" jqac /> 
	</dt> 		
	<dt>
...
{include file="InstockAbnormal/list.tpl"}
</div>  