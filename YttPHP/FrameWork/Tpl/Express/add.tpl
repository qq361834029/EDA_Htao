<form action="{'Express/insert'|U}" method="POST" onsubmit="return false">
...
<table cellspacing="0" cellpadding="0" class="add_table">
	...
	<tr>
		...
		<td class="t_left">
		<input type="text" name="comp_no" value="{$max_no}" {$is_auto_no} >__*__
		</td>
    	</tr>
    	<tr>
	...
	<tr>
      		<td>{$lang.priority}：</td>
      		<td class="t_left">
      			<input type="text" name="priority" class="spc_input" >
      		</td>
    	</tr>
    	<tr>
      		<td>{$lang.tax_no}：</td>
