<form action="{'OtherExpenses/update'|U}" method="POST" name="Basic_addPropertiesValue" onsubmit="return false">
...
<tbody>
	<tr><th colspan="2">{$lang.title_1}</th></tr>
     <tr>
      ...
      <td class="t_left"><input type="text" name="pv_no" value="{$rs.pv_no}" class="spc_input">__*__
      </td>
    </tr>
    <tr>
      <td>{$lang.pv_name}：</td>
