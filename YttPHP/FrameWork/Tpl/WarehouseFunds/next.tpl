<form action="{'WarehouseFunds/insert'|U}" method="POST" onsubmit="return false">
...
<div class="add_box">
		...
		<tr>
    			<th colspan="4">{$lang.warehouse_info}</th>
    	</tr>
    	<tr>
    			<td class="width15">{$lang.warehouse_name}：</td>
				<td class="t_left width30">
					<input type="hidden" name="comp_id" id="comp_id" value="{$rs.comp_id}">{$rs.w_name} 
				</td> 
