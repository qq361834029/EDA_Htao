<form action="{'Basic/update'|U}" method="POST" onsubmit="return false">
...
<table cellspacing="0" cellpadding="0" class="add_table">
	<tbody>
    	<tr>
      		...
      		<td class="t_left"><input type="text" name="basic_name" id="basic_name" value="{$rs.basic_name}" class="spc_input" >__*__</td>
    	</tr>
    	<tr>
      		<td>{$lang.tax_no}：</td>
    	...
    	<tr>
      		<td>{$lang.contact}：</td>
      		<td class="t_left"><input type="text" name="contact" class="spc_input" value="{$rs.contact}" id="contact"></td>
    	</tr>
    	<tr>
      		<td>{$lang.phone}：</td>
    	...
    	<tr>
      	...
      	<tr>
      		<td valign="top">{$lang.address}：</td>
       		<td class="t_left" valign="top"><textarea name="address" rows="5" cols="60">{$rs.edit_address}</textarea></td>
    	</tr>
    </tbody>
</table> 
</div>
