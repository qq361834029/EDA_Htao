...
{wz action="save,list,reset" title="customs_clearance"}
<div class="add_box">
<table cellspacing="0" cellpadding="0"  class="add_table" width="99%">
    		...
    		<tr>
    			...
    			<div class="titleth">
    				<div class="titlefl">{$lang.out_batch_basic}
                        ...
                        <input type="hidden" name="customs_clearance" value=true>
                        <input type="hidden" name="is_customs_clearance" value="1">
                    </div>
        ...
        <tr><td>{include file="OutBatch/customs_clearance_detail.tpl"}</td></tr>
    	</tbody> 
    </table>
