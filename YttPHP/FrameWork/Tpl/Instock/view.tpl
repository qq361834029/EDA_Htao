...
<table cellspacing="0" cellpadding="0" class="add_table">
	<tbody>
    	...
    	<tr>
    		<td  class="t_center">
    			{include file="Instock/box_detail_view.tpl"}
    		</td>
    	</tr>
		{if $rs.product}
    	<tr>
    	...
    	<tr>
    		<td  class="t_center">
			{include file="Instock/product_detail_view.tpl"}
    		</td>
    	</tr>		
		{/if}
			<tr>
				<td style="padding-top:10px;">
					<table cellspacing="0" cellpadding="0" width="100%">
						<tr>
							<td valign="top" width="15%" class="t_right">{$lang.client_comments}：</td>
        	...
        	<tr>
				<td style="padding-top:10px;">
					<table cellspacing="0" cellpadding="0" width="100%">
						<tr>
							<td valign="top" width="15%" class="t_right">{$lang.warehouse_comments}：</td>
