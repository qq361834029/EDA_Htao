<form action="{'FactoryFunds/add'|U}" method="POST" onsubmit="return false">
...
<div class="add_box">
  <table cellspacing="0" cellpadding="0" class="add_table">
    ...
    {/if}
      <td class="width10">{$lang.express_name}：</td>
      <td class="t_left">
      	...
      	<input type="text" name="factory_name" id='factory_name' url="{'AutoComplete/expressName'|U}" jqac>__*__
      </td>
    </tr>  
