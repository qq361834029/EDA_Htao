<form action="{'FactoryFunds/insert'|U}" method="POST" onsubmit="return false">
...
<div class="add_box">
		...
		<tr>
    			<th colspan="4">{$lang.express_info}</th>
    	</tr>
    	<tr>
    			<td class="width15">{$lang.express_name}：</td>
				<td class="t_left width30">
					<input type="hidden" name="comp_id" id="comp_id" value="{$rs.comp_id}">{$rs.express_name} 
				</td>
		...
		<tr>
				...
				<td  class="t_left">
					<input type="hidden" name="warehouse_id" value="{$rs.warehouse_id}">{$rs.warehouse_name_use} 
				</td>
        </tr>
		<!--
		<tr>
