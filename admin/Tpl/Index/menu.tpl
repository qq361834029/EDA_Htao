        ...
        <div id="menu" class="menu">
            <table class="list shadow" cellpadding=0 cellspacing=0 >
                ...
                {foreach item=item key=key from=$menu}
                                    <tr class="row " >
                                        <td><div style="margin:0px 5px"><img SRC="__PUBLIC__/Images/Admin/arrow.gif" WIDTH="9" HEIGHT="9" BORDER="0" align="absmiddle" ALT=""> <a href="__APP__/{$link_module}/{$item['module']}" id="{$key}" target="main">{$item['title']}</a></div></td>
                                    </tr>
                    {/foreach}
                <tr>
