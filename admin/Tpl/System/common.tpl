...
<tr>
	...
	<td class="tLeft" ><input type="radio" name="show_many_basic" value="1" {if $rs.show_many_basic==1}checked{/if}>是<input type="radio" name="show_many_basic" value="2" {if $rs.show_many_basic==2}checked{/if}>否</td>
</tr>
<tr>
 ...
 <tr>
	<td colspan="2">
	<input type="hidden" name="config_type" value="common">
